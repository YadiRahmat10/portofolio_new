    ...
    <section className="scroll-mt-32" id="Projects">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
        ...
        <div className="bg-surface-container-low/50 backdrop-blur-sm border border-outline-variant rounded-lg p-md flex flex-col h-full hover:border-primary transition-colors group">
          <div className="font-label-mono text-label-mono text-primary mb-2 opacity-80">// THREAT_INTEL</div>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <span className="bg-surface-container-high text-on-surface-variant font-code-sm text-code-sm px-2 py-1 rounded border border-outline-variant">Python</span>
            <span className="bg-surface-container-high text-on-surface-variant font-code-sm text-code-sm px-2 py-1 rounded border border-outline-variant">Elasticsearch</span>
        ...
        {/* Project Card 2 */}
        <div className="bg-surface-container-low/50 backdrop-blur-sm border border-outline-variant rounded-lg p-md flex flex-col h-full hover:border-primary transition-colors group">
          <div className="font-label-mono text-label-mono text-primary mb-2 opacity-80">// SECURE_ARCH</div>
        ...
        {/* Project Card 3 */}
        <div className="bg-surface-container-low/50 backdrop-blur-sm border border-outline-variant rounded-lg p-md flex flex-col h-full hover:border-primary transition-colors group">
          <div className="font-label-mono text-label-mono text-primary mb-2 opacity-80">// RECONNAISSANCE</div>
