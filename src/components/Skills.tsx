      ...
      <div className="max-w-container-max mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-md">
          ...
          <div className="bg-surface/50 backdrop-blur-sm border border-outline-variant rounded p-md hover:border-primary/50 transition-colors">
            <div className="font-label-mono text-label-mono text-secondary mb-4 border-b border-outline-variant/50 pb-2">
              // INFRASTRUCTURE
            </div>
            <ul className="space-y-2 font-code-sm text-code-sm text-on-surface-variant">
              <li className="flex items-center"><span className="text-primary mr-2">▹</span> Kubernetes</li>
              <li className="flex items-center"><span className="text-primary mr-2">▹</span> Terraform</li>
              <li className="flex items-center"><span className="text-primary mr-2">▹</span> Docker</li>
              <li className="flex items-center"><span className="text-primary mr-2">▹</span> GitHub Actions</li>
            </ul>
          </div>
